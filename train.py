...
def get_parser() -> argparse.Namespace:
    ...
    parser.add_argument("--gpus", '-g', default='0', help="the number of gpus for training.")
    parser.add_argument("--modal", '-m', default='0',
                        help="the way to training model\n\t0: single modal.\n\tmulti modal.")
    parser.add_argument("--data_dir", '-d', default="./prepare_datasets/data3c/", help="where the data is.")
    ...
    parser.add_argument("--from_fold", default='9', help="the first fold to train.")
    parser.add_argument("--train_fold", default='20', help="the folds you want to train this time.")
...
def train(args: argparse.Namespace, hyper_param_dict: dict) -> dict:
    ...
    model: tensorflow.keras.models.Model = U2Model(**hyper_param_dict)
